...
CREATE TABLE `user` (
  ...
  `level` int DEFAULT '0',
  `social_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `introduction` varchar(150) DEFAULT NULL,
  `method` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='가입 유저 정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,'testpasswrd','testnickname',20000423,3,'2024-01-20 03:35:03',0,'tombos9877@gmail.com','intro','google');
...
-- Dump completed on 2024-01-24 13:31:54
